...
public class ApiErrorResponse {
	...
	private void addValidationError(FieldError fieldError) {
		...
		if (fieldError.getField().equalsIgnoreCase("creditcard")) {
			code = "USR_08";
		...
		if (fieldError.getField().equalsIgnoreCase("dayphone")) {
			code = "USR_06";
			message = "this is an invalid phone number.";

		}

		if (fieldError.getField().equalsIgnoreCase("evephone")) {
			code = "USR_06";
			message = "this is an invalid phone number.";

		}

		if (fieldError.getField().equalsIgnoreCase("mobphone")) {
			code = "USR_06";
			message = "this is an invalid phone number.";
